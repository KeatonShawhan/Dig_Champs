class Level1_Controls extends Phaser.Scene {
  constructor() {
    super("level1_controlScene");
  }
  ...
  create() {
    ...
    this.background = this.add.sprite(width / 2, height / 2, 'level1_controls').setScale(.5);

    let textStroke = this.add.text(328, 43, 'LEVEL 1', {
    ...
    let textBlackThinStroke = this.add.text(335, 50, 'LEVEL 1', {
      fontFamily: '"ArcadeFont"',
      fontSize: '100px',
      stroke: '#000000',
      strokeThickness: 5,
    ...
    let textFill = this.add.text(338, 52, 'LEVEL 1', {
      fontFamily: '"ArcadeFont"',
      fontSize: '100px',
      color: '#d9581b'
    });
